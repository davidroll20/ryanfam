    ...
    <div class="event-modal__container" @click.stop v-if="store.eventBeingEdited">
      <div class="event-modal__control">
        ...
        <input
          ...
          v-model="store.eventBeingEdited.title"
        />
      </div>
      <div class="event-modal__control">
        ...
        <textarea
          ...
          class="event-modal__control--input"
          v-model="store.eventBeingEdited.description"
        />
      </div>
      <div class="event-modal__control">
        ...
        <input
          ...
          type="checkbox"
          class="event-modal__control--input"
          v-model="store.eventBeingEdited.allDay"
        />
      </div>
      <div class="event-modal__control">
        ...
        <input
          ...
          type="date"
          class="event-modal__control--input"
          v-model="store.eventBeingEdited.startDateStr"
        />
      </div>
      <div class="event-modal__control" v-if="!store.eventBeingEdited.allDay">
        <label for="event-start-time" class="event-modal__control--label">Start Time:</label>
        <select
          name="event-start-time"
          type="select"
          class="event-modal__control--input"
          v-model="store.eventBeingEdited.startTimeStr"
        >
      ...
      <div class="event-modal__control">
        ...
        <input
          ...
          type="date"
          class="event-modal__control--input"
          v-model="store.eventBeingEdited.endDateStr"
        />
      </div>
      <div class="event-modal__control" v-if="!store.eventBeingEdited.allDay">
        ...
        <select
          ...
          type="select"
          class="event-modal__control--input"
          v-model="store.eventBeingEdited.endTimeStr"
        >
